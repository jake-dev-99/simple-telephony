...
internal class CallManager(private val context: Context) {
    ...
    companion object {
        ...
        // Arbitrary request code for the default-dialer role dialog. The hex
        // spells "S(imple)T(elephon)Y" — just needs to be unique within the
        // host activity's request codes.
